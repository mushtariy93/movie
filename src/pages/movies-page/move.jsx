...
const MyMovies = () => {
  ...
  return (
    <div id="search" className="bg-black text-white min-h-screen">
            ...
            {genres?.length > 0 ? (
              [
                ...
                <button
                  ...
                  className={`py-3 px-5 rounded-md border-2 transition-all duration-300 whitespace-nowrap ${
                    selectedGenre.includes(genre.id)
                      ? "bg-blue-500 text-white border-none"
                      : "bg-gray-800 text-gray-300 border-red-500 hover:bg-red-600 hover:text-white"
                  }`}
                >

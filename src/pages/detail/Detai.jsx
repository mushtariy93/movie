    ...
    <div className="min-h-screen dark:bg-black dark:text-white text-black">
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col justify-center items-center">
            ...
            <div className="flex flex-wrap gap-4 max-[500px]:grid grid-cols-1">
              {images.backdrops.slice(0, 10).map((image, index) => (
                <img
                  ...
                  alt="Movie Scene"
                  className="w-56 h-32 object-cover rounded-full max-[500px]:w-full max-[500px]:h-full"
                />
              ))}
            </div>
          </div>
        ...
        <div className="detail-list w-[380px] mt-12">
          {/* Button Section */}
          <div className="grid grid-cols-2 gap-4 mb-12 max-[450px]:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-4 mb-12 max-[450px]:grid-cols-1">
            <button className="flex items-center justify-around border text-white border-[#111111] px-4 rounded-xl text-xl font-[900]">
              ...
              <img className="w-20 h-16" src={imdb} alt="IMDB" />
            </button>
            <button className="flex items-center justify-around text-white border border-[#111111] px-4 rounded-xl text-xl font-[900]">
              {data?.vote_average?.toFixed(1)}
              <img className="w-20 h-16" src={kinopoisk} alt="Kinopoisk" />
            </button>
          </div>

          {/* Movie Details */}
          <div className="border-b pb-8 border-[#2D2D2D]">
            <h3 className="text-center text-white text-xl">Детали</h3>
            <div className="flex flex-wrap justify-between mt-6 max-[450px]:grid max-[450px]:grid-cols-1">
            ...
            <div className="flex flex-wrap justify-between mt-4 max-[450px]:grid max-[450px]:grid-cols-1">
          ...
          {/* Cast Section */}
          <div className="border-b pb-8 border-[#2D2D2D]">
            <h3 className="text-center text-white text-xl">В ролях</h3>
            {translatedCasts.map((member, index) => (
              <div
                key={index}
                className="flex flex-wrap justify-between mt-4 max-[450px]:grid max-[450px]:grid-cols-1"
              >
                <p className="text-sm max-[450px]:text-center">{member.name}</p>
                <p className="text-sm max-[450px]:text-center">
                  {member.character}
                </p>
              </div>
